...
输出：
    agents/results/v8-result.md         全部 344 候选 + 4 排行榜
    agents/results/v8-tiny-result.md    Top 20 精选 + V6 对比 + 业务关联分析
"""
...
OUTPUT_RESULT = PROJECT_ROOT / "agents" / "results" / "v8-result.md"
OUTPUT_SUMMARY = PROJECT_ROOT / "agents" / "results" / "v8-summary.md"
OUTPUT_TINY = PROJECT_ROOT / "agents" / "results" / "v8-tiny-result.md"
